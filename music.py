...
drawing = mp.solutions.drawing_utils
    ...
    # Set custom CSS for the gradient background
st.markdown(
        """
        <style>
        .stApp {
                background: linear-gradient(to right, olive, red);
        }
        </style>
        """,
...
def program():
        ...
        # Use YouTube Data API to search for videos and get the video ID of the top result
...
#st.header("Welcome to the world of Emorsic")
